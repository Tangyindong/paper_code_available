...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
    ...
    # Shape1: [batch, num_rois, MASK_POOL_SIZE, MASK_POOL_SIZE, channels]
    ...
    # Shape2: [batch, num_rois, MASK_POOL_SIZE, MASK_POOL_SIZE, channels]
    x = TimeDistributed(Conv2D(256, (3, 3), padding="same"),
    ...
    # Shape3: [batch, num_rois, MASK_POOL_SIZE, MASK_POOL_SIZE, channels]
    x = TimeDistributed(Conv2D(256, (3, 3), padding="same"),
    ...
    # Shape4: [batch, num_rois, MASK_POOL_SIZE, MASK_POOL_SIZE, channels]
    x = TimeDistributed(Conv2D(256, (3, 3), padding="same"),
    ...
    # Shape反卷积: [batch, num_rois, 2xMASK_POOL_SIZE, 2xMASK_POOL_SIZE, channels]
...
def get_predict_model(config):
    ...
    # _, C2, C3, C4, C5 = get_resnet(input_image,alpha=1.0, train_bn=config.TRAIN_BN)
    # 组合成特征金字塔的结构
    # P5长宽共压缩了5次
...
def get_train_model(config):
    ...
    # P5长宽共压缩了5次
    # Height/32,Width/32,256
    P5 = Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (1, 1), name='fpn_c5p5')(C5)   #config.TOP_DOWN_PYRAMID_SIZE=256
    # P4长宽共压缩了4次
    # Height/16,Width/16,256
    P4 = Add(name="fpn_p4add")([
        UpSampling2D(size=(2, 2), name="fpn_p5upsampled")(P5),
